...
static constexpr std::string_view vis_chars_view{vis_chars.data() + 1,
                                                 vis_chars.size() - 2};
static constexpr std::string_view quoted_vis_chars_view{vis_chars.data(),
                                                        vis_chars.size()};

TEST_CASE("parse::String") {
  cli::parse::String<std::string_view> parse;
