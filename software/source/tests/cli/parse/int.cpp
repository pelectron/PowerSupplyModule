...
template <class Int> struct int_str {
  ...
  template <class I>
  constexpr int_str(I i, std::string_view str) : i(i), str(str) {}
  template <class I>
  constexpr int_str(int_str<I> other) : i(other.i), str(other.str) {}
};
template <class I> int_str(I i, std::string_view str) -> int_str<I>;
...
TEST_CASE("parse::Int<int>") {
  ...
  SECTION("empty string") { REQUIRE_FALSE(parser(std::string_view{})); }
