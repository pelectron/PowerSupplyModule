...
ClockTree &clock_tree() {
  static constinit ClockTree clock_tree_{};
  return clock_tree_;
}
//
...
//     switch (clock) {
//     case Clock::PCLK:
//       hal::mmio::set(RCC->CCIPR, RCC_CCIPR_I2C1SEL, 0u,
//       RCC_CCIPR_I2C1SEL_POS); break;
//     case Clock::SYSCLK:
//       hal::mmio::set(RCC->CCIPR, RCC_CCIPR_I2C1SEL, 1u,
//       RCC_CCIPR_I2C1SEL_POS); break;
//     case Clock::HSIKER:
